...
/// Notifier that manages the visibility state of the search bar
...
class ConnectionsScreen extends ConsumerWidget {
  ...
  void _connectToServer(
    ...
    // Update last accessed time when opening an existing session
    if (sessionName != null) {
...
/// Connection card (expandable, displays tmux sessions)
...
class _ConnectionCardState extends ConsumerState<_ConnectionCard> {
  ...
  Widget build(BuildContext context) {
    ...
    // Determine connection status (whether there are active sessions or lastConnectedAt exists)
      ...
      child: Column(
        ...
        children: [
          ...
          if (_isLoadingSessions)
            ...
            // Session list (using _sessions or activeSessions)
